Title: Kickstarter: NarwhalEdu
Starred: true
Date: 2013-05-27 15:57
Category: Leadership
Slug: NarwhalEdu-Kickstarter
Summary: Created lasercut drawing robot arm, coupled with online class. Successful $20k kickstarter.
...
![](/NarwhalEdu-Kickstarter/batchgeo.jpg)
...
<video id="narwhal" controls autoplay muted loop>
  <source src="/NarwhalEdu-Kickstarter/narwhal.webm" type="video/webm">
...
<video id="copying" controls autoplay muted loop>
  <source src="/NarwhalEdu-Kickstarter/copying.webm" type="video/webm">
  Your browser does not support the video HTML5 tag.
</video>  
</center>
...
![Our class on EdX](/NarwhalEdu-Kickstarter/edx.jpg)

![Our robot arm](/NarwhalEdu-Kickstarter/product.jpg)

<!--Drawing what was drawn on the screen-->
![Drawing a face using edge-detection on an image](/NarwhalEdu-Kickstarter/face.jpg)

![Shipping kits](/NarwhalEdu-Kickstarter/shipping_boxes.jpg)
