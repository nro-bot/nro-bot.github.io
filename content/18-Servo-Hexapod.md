...
<video id="Tripod gait" controls autoplay muted loop>
  <source src="/18-Servo-Hexapod/tripod_gait.webm" type="video/webm">
...
<!--<video id ="Hexapod Design" controls>-->
  <!--<source src="/18-Servo-Hexapod/design_of_hexapods.webm" type="video/webm">-->
  <!--Your browser does not support the video HTML5 tag.-->
<!--</video> -->
<!--</center>-->
![A picture of one of the first prototypes](/18-Servo-Hexapod/leg_prototype.jpg)
